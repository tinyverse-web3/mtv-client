...
import SpaceAuthenticatorDetail from '@/pages/space/authenticator/detail';
...
import AwardInvited from '@/pages/space/award/invited';
...
export const ROUTE_PATH_SPACE = {
  ...
  SPACE_AWARD_INVITED: '/space/award/invited',
  ...
  SPACE_AUTHENTICATOR_DETAIL: '/space/authenticator/detail',
...
export const spaceRoutes: RouteObject[] = [
  ...
  {
    path: ROUTE_PATH_SPACE.SPACE_AWARD_INVITED,
    element: <AwardInvited />,
  },
  ...
  {
    path: ROUTE_PATH_SPACE.SPACE_AUTHENTICATOR_DETAIL,
    element: <SpaceAuthenticatorDetail />,
  },
  {
